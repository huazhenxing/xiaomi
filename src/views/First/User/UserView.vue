<template>
  <div class="app-view">
    ...
    <div class="b1 ui-flex align-center justify-space-between">
      ...
      <div class="span ui-flex align-center">全部订单</div>
    </div>
...
.app-view {
  ...
  .b2 {
    ...
    .thx {
      .icon {
        ...
        height: 25rem;
        margin: 0 auto 8.333rem;
        background: url(https://m.mi.com/static/img/nav-4.d68723895f.png)
          no-repeat center 0;
        background-size: 100% auto;
      }
    }
  ...
  .items {
    ...
    li {
      position: relative;
      color: rgba(0, 0, 0, 0.54);
      background: url(https://m.mi.com/static/img/i-setting.fb9625b3f2.png)
        no-repeat 17rem;
