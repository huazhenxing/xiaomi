    ...
    ">
      ...
      <div class="vote-box">
        <div class="vote-status layout align-center active">
          <span class="i active">进行中</span>{{ content.vote_detail.vote_user_num }}人参与
        </div>
        <div class="vote-list active">
          <div class="vote-list-item" v-for="item in content.vote_detail.vote_option_list" :key="item.vote_option_id">
