	...
	<div class="app-view">
		<div class="app-product-container" v-if="data">
			...
			<div class="section">
				<div class="product_info_product_desc">
					...
					<div class="overview overview-sell-point">
						<div class="sell_point_desc fz-xs" v-for="(item, index) in product_info.sell_point_desc"
							:key="index">
				...
				<div class="product_info_choose_version">
					<div class="card-box">
						<div class="product-section-box">
							<div class="product-section padding-26-0-0-32" @click="clickChoose">
								<div class="ui-flex">
                    ...
                    ">
										<div class="product-img">
											<img :src="goods_info[change_index].img_url"
												alt="" />
										</div>

										<div class="product-desc flex layout column justify-start">
											<div class="product-price">
												<div class="cur-price">&yen; {{ goods_info[change_index].price }}</div>
												<div class="origin-price">&yen; {{ goods_info[change_index].market_price }}</div>
											</div>
											<div class="name">{{ goods_info[change_index].name }}</div>
										</div>
									</div>
                        ...
                        ">
                            ...
                            class="
                              ...
                              ui-flex
                            " 
                            :key="attr.prop_value_id" v-if="item.show_attr_list.includes(attr.prop_value_id)" @click="clickVersion(attr.prop_value_id, index)"
														:class="{ on: attr.prop_value_id == selected_attr_list[index] }">
														<!-- on -->
														<p>{{ attr.name }}</p>
													</div>
												</template>
										...
										<div class="ywb">
											...
											<div class="ywb-row">
												<div class="option-title-sub">
													<img src="https://m.mi.com/static/img/icon-accident.77f043afba.png"
                              ...
                              ">
											...
											<div class="ywb-row">
												<div class="option-title-sub">
													<img src="https://m.mi.com/static/img/icon-extend.a8e55bfef6.png"
														alt="" class="service-icon" />
                              ...
                              ">
											...
											<div class="ywb-row">
												<div class="option-title-sub">
													<img src="https://m.mi.com/static/img/icon-cloud.e8449c43c3.png"
														alt="" class="service-icon" />
					...
					<div class="blank_line offset-top-1px" style="height: 10.414rem; background: rgb(246, 246, 246)">
					</div>
				</div>
			</div>
				...
				<div class="product_info_comment">
					<div class="comments-gallery">
						...
						<div class="comments-tags">
							<div class="comments-tags-text" v-for="item in comments.detail.comment_tags"
								:key="item.tag_id">
								{{ item.tag_name }}
							</div>
						</div>
						...
						<div class="swiper-wrapper">
							<div class="swiper-slide swiper-slide-active" v-for="item in comments.list"
								:key="item.user_id">
								<div class="swiper-box">
									...
									<div class="comment-content">
										...
										<div class="photos">
											<div class="img" v-for="(item, index) in item.image_infos" :key="index">
			...
			<div class="section">
									...
									<van-swipe class="my-swipe" indicator-color="white" :show-indicators="false"
										...
										<van-swipe-item v-for="(item, index) in recommend_goods_arr" :key="index">
											<div class="product-tab" style="width: 342px">
												<CommodityDox v-for="item in item" :key="item.product_id"
													:item="item" />
											</div>
										</van-swipe-item>
									</van-swipe>
				...
				<div class="blank_line offset-top-1px" style="
            height: 10.414rem;
            background: rgb(246, 246, 246);
			...
			<div class="section">
				<div class="description-view">
					<div class="tab-header border-bottom-1px">
						...
						<span @click="clickDescription(index)" class="flex" v-for="(item, index) in description"
							:key="index" :class="{ on: index == description_index }">{{ item.tab_name }}</span>
					</div>
				</div>
				<div class="tab-view">
					<div class="image_w_1080" v-for="item in description[description_index].page_info"
						:key="item.block_id">
				...
				<div class="product_info_recommend">
					<div class="recommend-box">
						...
						<div class="recommend-list">
							<RecommendGoodsItem v-for="item in recommend_goods" :key="item.product_id" :item="item" />
						</div>
					</div>
				</div>
			</div>
	...
	export default {
		...
		mounted() {
			...
			this.axios({
				...
				this.change_index = 0
				this.selected_attr_list = this.goods_info[this.change_index].prop_list.map(item => item.prop_value_id)
      ...
      attrShowIdx(idx) {
        ...
        while(start <= idx) {
          goods_list = goods_list.filter(item => item.prop_list[start].prop_value_id == this.selected_attr_list[start])
          start++
        }
        while(start < len) {
          let attr_list = []
          for(let i = 0; i < goods_list.length; i++) {
            if(!attr_list.includes(goods_list[i].prop_list[start].prop_value_id)) {
      ...
      getGoodsChangeIndex() {
        this.change_index = this.goods_info.findIndex(item => {
          return item.prop_list.every((prop, index) => prop.prop_value_id == this.selected_attr_list[index])
        })
      }
		},
	};
